...
- more samples for settings the guide says to leave at defaults (Breakout Positions into Long and Short, Combine by Underlying, Display Canceled Trades, Group Buys and Sells) — today they are caught only if they change trades columns
